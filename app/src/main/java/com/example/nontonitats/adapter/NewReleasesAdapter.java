...
public class NewReleasesAdapter extends RecyclerView.Adapter<NewReleasesAdapter.ViewHolder> {
    ...
    public NewReleasesAdapter(List<Movie> movieList, OnMovieClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_movie_new_releases, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Tampilkan badge NEW untuk 3 film pertama
        holder.tvNewBadge.setVisibility(position < 3 ? View.VISIBLE : View.GONE);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ImageView ivPoster;
        TextView tvTitle, tvRating, tvNewBadge;
